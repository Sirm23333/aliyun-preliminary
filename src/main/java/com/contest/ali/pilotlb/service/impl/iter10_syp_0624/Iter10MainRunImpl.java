 ...
 * */
@Slf4j
public class Iter10MainRunImpl implements MainRun {

    Iter10DataHandler dataHandler = new Iter10DataHandler();
    ...
    public Map<String, List<String>> stage1Run(List<String> pilotNames, String dataPath) {
        ...
        new Game( GlobalContain.APP_LIST_MERGE_II , GlobalContain.SERVICE_LIST , GlobalContain.PILOT_LIST, GlobalConstant.STAGE_1,10,0.01).gameRun();
        dataHandler.formatPilotListII(GlobalContain.PILOT_LIST); // 把第二次合并的拆开
        new Game( GlobalContain.APP_LIST_MERGE , GlobalContain.SERVICE_LIST , GlobalContain.PILOT_LIST,GlobalConstant.STAGE_1,10,0.01).gameRun();
        dataHandler.formatPilotList(GlobalContain.PILOT_LIST); // 把第一次合并的拆开
        new Game( GlobalContain.APP_LIST_SRC , GlobalContain.SERVICE_LIST , GlobalContain.PILOT_LIST,GlobalConstant.STAGE_1,5,0.01).gameRun();
    ...
    public Map<String, List<String>> stage2Run(JSONObject data) {
        ...
        new Game( GlobalContain.APP_LIST_SRC  , GlobalContain.SERVICE_LIST , GlobalContain.PILOT_LIST,GlobalConstant.STAGE_2,2,0.01).gameRun();
        return result = dataHandler.buildResultMap(GlobalContain.PILOT_LIST);
    }
